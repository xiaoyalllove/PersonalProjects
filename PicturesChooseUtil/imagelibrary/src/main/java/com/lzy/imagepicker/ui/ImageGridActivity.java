...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener, TakePhoto.TakeResultListener, InvokeListener {
...
//            mBtnPre.setEnabled(false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (ImagePicker.REQUEST_CODE_MYCROP == resultCode) {
            Intent intent = new Intent();
            intent.putExtra(ImagePicker.EXTRA_IMAGE_CROP, data.getStringExtra(ImagePicker.EXTRA_IMAGE_CROP));
            setResult(ImagePicker.REQUEST_CODE_MYCROP, intent);
            finish();
        }
        if (data != null) {
    ...
    public void takeSuccess(TResult result) {
        CropManager.getInstance().cropSuccessBack(ImageGridActivity.this, result);
    }
